                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                <a href="/goto-viewparent" class=" waves-effect">
                                    <i class="mdi mdi-calendar-month"></i>
                                    <span style="color: #FCFBFC;">Parents Details</span>
                                </a>
                            </li>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table style="overflow: hidden;" class="table table-centered table-nowrap mb-0" id="example" class="display">
                                                ...
                                                <tbody>
                                                    <c:forEach var="g" items="${guaadmin}">
                                                        <tr>
                                                            <td>
                                                                <p class="nr1" class="mb-1 font-size-12">#${g.id}</p>
                                                                <h5 class="nr2" class="font-size-15 mb-0">${g.gurFname} ${g.gurLname}</h5>
                                                            </td>
                                                            <td class="nr3">${g.gurEmail}</td>
                                                            <td class="nr4">${g.gurStudentmail}</td>
                                                            <td class="nr5">${g.gurAddress}</td>
                                                            <td class="nr6">${g.gurMobile}</td>
