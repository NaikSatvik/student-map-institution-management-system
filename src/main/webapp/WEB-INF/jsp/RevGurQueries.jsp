        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">  
            <div class="modal-dialog modal-lg">  
                ...
                <div class="modal-body">  
                    ...
                    <form class="custom-validation" action="/saveReplyGur" method="POST">
                        <div class="form-group">
                            <label>Query</label>
                            <input name="gurQueryContent" type="text" class="form-control" id="query" readonly/>
                        </div>
                        <div class="form-group">
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                ...
                                <li><a style="color: #FCFBFC;" href="/revertGurQueries">Guardian Queries</a></li>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table style="overflow: hidden;" class="table table-centered table-nowrap mb-0" id="example" class="display">
                                            ...
                                            <tbody>
                                                <c:forEach var="s" items="${getGurQ}">
                                                    <tr>
                                                        <td class="nr1">${s.gurQueryContent}</td>
