                ...
                <div class="main-content">
                    ...
                    <div class="page-content">
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <h4>Complete Your Profile To Redirect To Dashboard</h4>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="card">
                                        <div class="card-body">
                                            <form class="custom-validation" action="/save-StuProfile">
                                                ...
                                                <div class="form-group">
                                                    <label>Address</label>
                                                    <div>
                                                        <textarea required class="form-control" rows="5" name="stuAddress"></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label>Pincode</label>
                                                    <div>
                                                        <input type="text" class="form-control" name="stuPincode" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label>Enrollment No.</label>
                                                    <div>
                                                        <input type="text" class="form-control" name="stuEnroll" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <label>Hobby</label>
                                                    <div>
                                                        <input type="text" class="form-control" name="stuHobby" />
                                                    </div>
                                                </div>
