                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                ...
                                <li><a style="color: #FCFBFC;" href="UploadNotice">Upload Notice</a></li>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <form action="SaveNotice" method="post" style="width:100%;">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input  name="facName" class="form-control" type="text"  id="example-text-input">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-md-2 col-form-label">Email-ID</label>
                                            <div class="col-md-10">
                                                <input name="facEmail"  class="form-control" type="text"  id="example-text-input" value="${sessionScope.mail}" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-md-2 col-form-label">Notice Subject</label>
                                            <div class="col-md-10">
                                                <input name="sub" class="form-control" type="text"  id="example-text-input">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-md-2 col-form-label">Write notice content</label>
                                            <div class="col-md-10">
