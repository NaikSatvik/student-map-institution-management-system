                                                    ...
                                                    <c:forEach var="s" items="${listStudents}">
                                                        <tr>
                                                            <form action="follow" method="POST">
                                                                <input type="email" value="${sessionScope.mail}" name="sEmail" hidden/>
                                                                <input type="text" value="${s.stuEmail}" name="stuName" hidden/>
                                                                <input type="text" value="Pending" name="status" hidden/>
                                                                <td class="nr3">${s.id}</td>
                                                                <td class="nr4">${s.stuFname} ${s.stuLname}</td>
                                                                <td class="nr5"><input class="btn btn-outline-success btn-sm" type="submit" value="Follow"/></td>
                                                            </form>
                                                        </tr>
                                                    </c:forEach>
                                                </tbody>
