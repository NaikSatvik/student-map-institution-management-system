                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block">
                            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                                ...
                                <span class="d-none d-sm-inline-block ml-1">${sessionScope.stuEmail}</s>
                                        ...
                                        <form class="custom-validation" action="#">
                                            <c:forEach var="s" items="${facprofile}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <input type="text" class="form-control" value="${s.facEmail}" readonly/>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label>Address</label>
                                                    <div>
                                                        <textarea required class="form-control" rows="5" readonly>${s.facAddress}</textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label>Pincode</label>
